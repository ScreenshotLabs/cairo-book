...
<span className="caption">Listing 3-1: A variable and the scope in which it is
valid</span>
...
understanding by using the `Array` type we introduced in the [previous chapter](ch02-06-common-collections).

## Ownership with the `Array` Type

To illustrate the rules of ownership, we need a data type that is more complex.
The types covered in the [Data Types](ch02-02-data-types) section
...
<span className="filename">Filename: src/main.cairo</span>
...
<span className="caption">Listing 3-3: Functions with ownership and scope
annotated</span>
...
<span className="caption">Listing 3-4: Transferring ownership of return
values</span>
...
<span className="caption">Listing 3-5: Returning ownership of parameters</span>
