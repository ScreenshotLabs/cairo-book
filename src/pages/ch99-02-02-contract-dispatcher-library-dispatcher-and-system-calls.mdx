...
<span className="caption">Listing 9-2: An expanded form of the IERC20 trait</span>
...
<span className="caption">Listing 9-3: A sample contract which uses the Contract Dispatcher</span>
...
<span className="caption">Listing 9-4: An expanded form of the IERC20 trait</span>
...
<span className="caption">Listing 9-4: A sample contract using the Library Dispatcher</span>
...
<span className="caption">Listing 9-5: A sample contract implementing system calls</span>
