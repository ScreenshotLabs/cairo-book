...
<span className="caption">Listing 6-3: Calling the `add_to_waitlist` function using absolute and relative paths</span>
...
<span className="caption">Listing 6-4: Calling a function using a relative path starting with super</span>
