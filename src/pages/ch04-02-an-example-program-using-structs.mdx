...
<span className="caption">Listing 4-6: Calculating the area of a rectangle specified by separate width and height variables</span>
...
<span className="caption">Listing 4-7: Specifying the width and height of the rectangle with a tuple</span>
...
<span className="caption">Listing 4-8: Defining a `Rectangle` struct</span>
...
<span className="caption">Listing 4-9: Attempting to print a `Rectangle` instance</span>
...
<span className="caption">Listing 4-10: Implementing the `PrintTrait` trait on `Rectangle`</span>
