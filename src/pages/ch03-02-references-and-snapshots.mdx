...
<span className="caption">Listing 3-6: Attempting to modify a snapshot value</span>
...
<span className="caption">Listing 3-7: Use of a mutable reference to modify a value</span>
