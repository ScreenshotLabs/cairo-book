...
<span className="caption">Listing 6-11: Declaring the `front_of_house` module whose
...
<span className="filename">Filename: src/front_of_house.cairo</span>
...
<span className="caption">Listing 6-12: Definitions inside the `front_of_house`
...
to an Item in the Module Tree”](paths). In other words,
...
<span className="filename">Filename: src/front_of_house/hosting.cairo</span>
...
[paths](ch06-03-paths-for-referring-to-an-item-in-the-module-tree)
