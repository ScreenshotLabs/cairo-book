...
<span className="filename">Filename: main.cairo</span>
...
Most terminals support the keyboard shortcut <span className="keystroke">ctrl-c</span> to interrupt a program that is
