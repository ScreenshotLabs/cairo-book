...
<span className="caption">Listing 9-1: A simple naming service contract</span>
...
<span className="caption">Listing 9-2: A Storage Struct</span>
...
<span className="caption">Listing 9-3: Calling the `read` function on the `names` variable</span>
...
<span className="caption">Listing 9-4: Writing to the `names` variable</span>
