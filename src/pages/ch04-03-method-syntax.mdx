...
<span className="filename">Filename: src/lib.cairo</span>
...
<span className="caption">Listing 4-13: Defining an `area` method to use on the
`Rectangle` </span>
...
<span className="caption">Listing 5-14: Using the as-yet-unwritten `can_hold`
method</span>
...
<span className="caption">Listing 5-15: Implementing the `can_hold` method on
...
namespaces created by modules. We’ll discuss modules in [Chapter 7](ch07-00-generic-types-and-traits).
...
<span className="caption">Listing 5-16: Rewriting Listing 5-15 using multiple `impl`
blocks</span>
...
useful in [Chapter 7](ch07-00-generic-types-and-traits), where we discuss generic types and traits.
