...
<span className="caption">Table 3-1: Integer Types in Cairo</span>
...
<span className="caption">Table 3-2: Integer Literals in Cairo</span>
...
[control-flow](/ch02-05-control-flow)
